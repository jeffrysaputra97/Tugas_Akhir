...
\subsection{\textit{Overall Performance} (OVR)}
\noindent \textit{Overall Performance} atau OVR adalah alat ukur untuk mengetahui performa keseluruhan dari aplikasi pada penelitian ini. Perhitungan persentase OVR dilakukan dengan cara membagi jumlah plat nomor yang terdeteksi dan dapat dikenali dengan benar terhadap jumlah keseluruhan plat nomor pada \textit{dataset} seperti yang dapat dilihat pada persamaan \ref{eq:ovr}. 
